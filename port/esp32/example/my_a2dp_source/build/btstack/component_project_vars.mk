...
COMPONENT_INCLUDES += $(IDF_PATH)/components/btstack/3rd-party/bluedroid/decoder/include $(IDF_PATH)/components/btstack/3rd-party/bluedroid/encoder/include $(IDF_PATH)/components/btstack/3rd-party/hxcmod-player $(IDF_PATH)/components/btstack/3rd-party/hxcmod-player/mods $(IDF_PATH)/components/btstack/src/classic $(IDF_PATH)/components/btstack/src/ble/gatt-service $(IDF_PATH)/components/btstack/src/ble $(IDF_PATH)/components/btstack/src/classic $(IDF_PATH)/components/btstack/src $(IDF_PATH)/components/btstack/platform/embedded $(IDF_PATH)/components/btstack/platform/freertos $(IDF_PATH)/components/btstack/include
